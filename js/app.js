...
const min = max - 10; // maximo de 10 años

//Generamos un objrto con la busqueda
const datosBusqueda = {
    marca : '',
    year : '',
    minimo : '',
...
function llamarSelect(){
    ...
    for (let i = max; i > min; i--) {
        ...
        year.appendChild(option);// agregamos y generamos las opciones a años de html
        
    }

};

// Funcion que filtra en base de busqueda
